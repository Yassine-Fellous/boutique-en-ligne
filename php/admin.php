...
{
    header('Location: index.html'); // Redirection à l'accueil si la personnes n'est pas admin ou non connectée.
    die();
}
...
<body>
    <main>
        ...
        <div class="flex-button">
            <a href="ajouter-produits.php"><input class="connexion" value="Ajouter un produit"></input>
        </div><br />
        <div class="flex-button">
            <a href="supprimer-produits.php"><input class="connexion" value="Supprimer un produit"></input></a>
        </div><br />