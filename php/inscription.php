      ...
      <div class="module-co-zone">
        <div class="formulaire">
          <form method="POST" action="traitement/tinscription.php">
            <label>
              <input type="text" name="nom" placeholder="Votre nom ..." maxlength="255" required value="<?php if (isset($_SESSION['nom'])) {
                                                                                                          echo $_SESSION['nom'];
                                                                                                        } ?>"><br /></input>
            </label>
            <label>
              <input type="text" name="prenom" placeholder="Votre prénom ..." maxlength="255" required value="<?php if (isset($_SESSION['prenom'])) {
                                                                                                                echo $_SESSION['prenom'];
                                                                                                              } ?>"><br /></input>
            </label>
            <label>
              <input type="text" name="email" placeholder="E-mail ..." maxlength="255" required value="<?php if (isset($_SESSION['email'])) {
                                                                                                          echo $_SESSION['email'];
                                                                                                        } ?>"><br /></input>
            </label>
            <label>
              <input type="text" name="adresse" placeholder="Adresse ..." maxlength="255" required value="<?php if (isset($_SESSION['adresse'])) {
