          ...
          <div class="module-co-zone">
            <div class="formulaire">
              <form method="POST" action="traitement/tconnexion.php">
                <label>
                  <input type="text" name="login" placeholder="Adresse mail ..." maxlength="255" required value="<?php if (isset($_SESSION['email'])) {echo $_SESSION['email']; } ?>"><br /></input>
                </label>
                <label>
                ...
                Vous pouvez tenter une <a href="recuperation.php">récupération.</p5></a><br />
