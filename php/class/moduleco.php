...
class Modulco
{
    ...
    {        
        ...
        {
            if (filter_var($email, FILTER_VALIDATE_EMAIL)) // Vérifie si l'adresse mail est correcte.
            {
            ...
            {
                $_SESSION['fail'] =  '<font color="red">L\'adresse mail saisie n\'est pas correcte.</font>';
                header('Location:../inscription.php');
            }
        }
        else
    ...
    public function updatepassword($_password, $_passwordConfirm)
    {
        ...
        {
            $newpassword = hash('sha256', $_password);
